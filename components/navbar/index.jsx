  ...
  return (
    <div className='px-6 py-4 border-b sticky top-0 z-50 bg-slate-50 hidden md:flex justify-between gap-12 items-center  '>
        <div className='flex items-center lg:flex-1 justify-between gap-12'>
            <p className='font-extrabold tracking-tighter text-2xl flex '>E-<span className='text-highlight'>COMMERCE</span></p>
            <nav className='hidden lg:flex items-center gap-4 mr-6 '>
                <Button variant="link" className='text-base text-highlight font-semibold tracking-wide'>Product</Button>
                <CategorySelect />
            </nav>
        </div>
        <Search />
